...
class Category {
  ...
  const Category({required this.id, required this.title, required this.imageFileName});
}
...
class AppDatabase {
  static const List<StoryData> stories = [
    StoryData(id: 1001, name: 'Emilia', imageFileName: 'story_9.jpg', iconFileName: 'category_1.png', isViewed: false),
    StoryData(
        id: 1002, name: 'Richard', imageFileName: 'story_10.jpg', iconFileName: 'category_2.png', isViewed: false),
    ...
    StoryData(
        id: 1005, name: 'Isabella', imageFileName: 'story_4.jpg', iconFileName: 'category_2.png', isViewed: false),
